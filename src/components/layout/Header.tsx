    ...
    <header className="sticky top-0 z-50 bg-white/80 backdrop-blur border-b border-gray-100 shadow-sm">
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-gray-600">
          ...
          <Link to="/archives" className="hover:text-blue-600 transition-colors">
            归档
          </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          {isLoggedIn ? (
            ...
            <Link
              to="/login"
              className="hidden md:flex items-center gap-1.5 text-gray-600 hover:text-blue-600 hover:bg-blue-50 text-sm font-medium px-4 py-2 rounded-lg transition-colors border border-gray-200"
            >
