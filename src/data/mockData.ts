...
export const initialPosts: Post[] = [
  {
    ...
    excerpt: 'React 19 带来了许多令人兴奋的新特性，包括 Actions、新的 Hooks、以及对 Web Components 的原生支持。本文将深入探讨这些新特性。',
...
async function updateName(formData) {
  ...
  },
  {
    ...
    excerpt: '深入理解 TypeScript 高级类型，通过实战案例掌握条件类型、映射类型、模板字面量类型等高级特性。',
...
type B = IsString&lt;number&gt;; // false</code></pre><h3>映射类型</h3><p>映射类型可以基于现有类型创建新类型：</p><pre><code>type Readonly&lt;T&gt; = {
  ...
  },
  {
    ...
    excerpt: 'Tailwind CSS v4 采用全新架构，基于 CSS 原生变量和 @layer 规则，性能大幅提升。了解如何从 v3 迁移到 v4。',
  ...
  },
  {
    ...
    excerpt: '通过实际案例分析 Node.js 应用的性能瓶颈，并提供针对性的优化策略，包括内存管理、异步优化和集群部署。',
